...
(defun single-html-to-org (htmlfile)
...
(setq test-html "/home/yiddi/Downloads/tensorflow_tutorial/xxx/Training_TensorFlow.html")
(single-html-to-org test-html)
...
(defun del-single-html-and-modify-exmp (htmlfile)
      (setq pathwithoutext (file-name-sans-extension htmlfile))
      (setq orgfile (concat pathwithoutext ".org"))
...
;; for test
(del-single-html-and-modify-exmp test-html)
...
;; for testing
(simple-del-html-md "/home/yiddi/Downloads/tensorflow_tutorial/xxx/")
...
(setq ttdir "/home/yiddi/Downloads/tensorflow tutorial/")
(yid-html-to-org ttdir)
